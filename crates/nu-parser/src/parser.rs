                    ...
                    match parse_mode {
                        ParseMode::Arg | ParseMode::AfterCommaArg => {
                            ...
                            // This is the same as the short flag in --b(-a)
                                ...
                                if multiple || matches!(parse_mode, ParseMode::AfterCommaArg) {
                                    working_set
                            ...
                            if let Some(last) = args.last_mut() {
                                ...
                                match last {
                                    ...
                                    Arg::Flag {
                                        ...
                                        working_set.set_variable_type(var_id.expect("internal error: all custom parameters must have var_ids"), typ);
